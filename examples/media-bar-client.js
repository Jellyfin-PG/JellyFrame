(function () {
    ...
    function tryInit() {
        ...
        fetchItems().then(function (items) {
            ...
            // Re-verify the DOM hasn't already drawn it during the fetch
            if (document.getElementById(BAR_ID)) return;

            // Re-fetch the target because the DOM may have changed during the async fetch
            ...
            if (currentTarget.parentNode) {
                currentTarget.parentNode.insertBefore(bar, currentTarget);
            } else {
